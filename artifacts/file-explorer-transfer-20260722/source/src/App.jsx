    ...
    <div dir="rtl" className="min-h-screen relative bg-theme-bg-base text-theme font-heebo selection:bg-primary/30">
      ...
      <div className="relative z-20 flex flex-col w-full h-full">
        ...
        <main
          ...
          className={`home-portal-main w-full relative min-h-[calc(100vh-80px)] flex flex-col justify-between overflow-x-clip pt-4 [@media(max-height:850px)]:pt-2 lg:pt-8 xl:pt-12 ${regularLinksLayout === 'sidebar-right' ? 'home-portal-main--right-sidebar' : ''}`}
        >
          {heroGlassEffect && (
            <div
