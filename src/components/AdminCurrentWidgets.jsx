...
export default function AdminCurrentWidgets() {
  ...
  const renderSelectedWidgetManager = () => {
    ...
    return (
      <div className="rounded-xl border border-primary/20 bg-primary/10 p-4 text-sm text-grey-muted">
      ...
      <div className="flex-1 min-h-0 px-8 pb-8 pt-4 overflow-y-auto 2xl:overflow-hidden">
        <div className="h-full flex flex-col gap-6 2xl:flex-row 2xl:items-stretch">
          <div className="flex-1 min-h-0 space-y-6 2xl:overflow-y-auto 2xl:pr-2 custom-scrollbar">
            <div className="rounded-xl border border-grey-subtle bg-grey-card px-4 py-3">
              <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
                <div className="min-w-0">
                  <h2 className="text-base font-bold text-grey">בחירת דף ניהול פעיל</h2>
                  <p className="mt-1 text-xs text-grey-muted">בחר איזה מהווידג׳טים הפעילים תרצה לנהל עכשיו.</p>
                ...
                <div className="w-full xl:w-[300px] xl:shrink-0 rounded-lg border border-grey-subtle bg-grey-elevated px-3 py-2.5">
                  ...
                  />
                  <div className="mt-1 flex items-center justify-between text-[11px] text-grey-muted">
                    <span>3 שנ׳</span>
                    <span>30 שנ׳</span>
                  </div>
                </div>
