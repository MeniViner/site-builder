    ...
    return (
        <div dir="rtl" className="min-h-screen bg-gray-100 p-8 font-heebo text-gray-900 dark:bg-[#1e212b] dark:text-white">
            ...
            <div className="mb-6 flex items-center justify-between">
                ...
                <button onClick={openNew} className="flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-bold text-white transition hover:bg-indigo-700">
                    <Plus size={16} />
                    הוסף ציטוט
                </button>
            </div>
            ...
            {editingId !== null && (
                <div className={`${panelCls} mb-6 rounded-2xl p-6 shadow-lg`}>
                    ...
                    <div className="mt-4 flex gap-3">
                        <button onClick={commitEdit} className="flex items-center gap-2 rounded-lg bg-indigo-600 px-5 py-2 text-sm font-bold text-white transition hover:bg-indigo-700">
                            <Check size={16} />
