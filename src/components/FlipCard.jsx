...
export const FlipCard = ({ id, title, icon: iconName, subLinks = [], url, isFlipped, onFlip }) => {
    ...
    return (
        ...
        >
            ...
            >
                <div className="absolute inset-0 [backface-visibility:hidden] bg-gradient-to-br from-white to-gray-100 dark:from-[#1a1c23] dark:to-[#111318] border border-gray-200 dark:border-gray-800 group-hover:border-red-500/50 group-hover:shadow-[0_0_20px_rgba(220,38,38,0.15)] transition-all rounded-xl p-6 flex flex-col items-center justify-center text-gray-700 dark:text-gray-200">
                ...
                <div className="absolute inset-0 [backface-visibility:hidden] [transform:rotateY(180deg)] bg-gradient-to-br from-gray-100 to-gray-50 dark:from-[#111318] dark:to-[#0a0c0f] border border-gray-200 dark:border-gray-800 rounded-xl p-5 flex flex-col shadow-2xl">
                    <div className="flex justify-between items-center mb-3 border-b border-gray-200 dark:border-gray-800 pb-3">
                        ...
                        <button
                            type="button"
                            className="text-gray-400 dark:text-gray-500 hover:text-red-500 transition-colors bg-gray-100 dark:bg-gray-900/50 rounded-md p-1"
                            onClick={handleClose}
                            aria-label="סגור"
                        >
                            <Undo2 size={16} />
                    ...
                    <div className="flex flex-wrap gap-1.5 flex-1 content-center">
                        {(subLinks || []).map((link, idx) => {
                            return (
                                ...
                                >
                                    <DynamicIcon name={link.icon} size={14} className="text-gray-400 dark:text-gray-500 group-hover/btn:text-red-400 shrink-0" />
