...
export const AI_CONFIG = Object.freeze({
    ...
    fileEndpoint: String(import.meta.env.VITE_ALPHA_AI_FILE_ENDPOINT || '/ai/files/analyze').trim(),
    ...
    fileTimeoutMs: parseNumber(import.meta.env.VITE_ALPHA_AI_FILE_TIMEOUT_MS, 120000),
