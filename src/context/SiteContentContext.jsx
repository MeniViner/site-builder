...
function ensureLegacySiteContentContract(content) {
    ...
    return {
        ...
        commander: {
            ...
            imageRank: normalizedCommander.imageRank,
            imageRankStyle: normalizedCommander.imageRankStyle,
            imageRankBackdrop: normalizedCommander.imageRankBackdrop,
            imageRankOrientation: normalizedCommander.imageRankOrientation,
            imageRankRotation: normalizedCommander.imageRankRotation,
            imageRankMirrored: normalizedCommander.imageRankMirrored,
