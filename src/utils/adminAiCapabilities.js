...
function pageSchema(tab) {
  const schemas = {
    ...
    theme: '{"theme":{"primaryColor":"#0891b2","displayMode":"user-toggle|dark|light","borderStyle":"standard|square|cyber|armor|shield|blade","useTintedBackground":true,"tintedBackgroundStrength":72,"heroGrayscale":false,"heroGlassEffect":false,"heroGlassStrength":58,"topNavGlassEffect":true,"topNavGlassStrength":1,"showNavCategories":true,"regularLinksLayout":"sidebar-right|grid|compact|hq","externalLinksLayout":"cards|minimal|floating","externalLinksFixed":false,"externalLinksBordered":true,"externalLinksShowBackground":true,"widgetHeight":"full|high|medium|low"}}',
