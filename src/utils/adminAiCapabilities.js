...
export const ADMIN_AI_CAPABILITIES = Object.freeze({
  ...
  boom: {
    ...
    actions: [
      ...
      action('dashboard', 'עדכן לוח בקרה', 'תאר מה חשוב לראות וה-AI יבחר הגדרות לוח בקרה מתוך האפשרויות הקיימות.'),
